...
<div class="card shadow-sm">
    <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
        ...
        <a href="<?= BASE_URL ?>/sa/user/create" class="btn btn-light btn-sm">➕ <?= __('add_user') ?></a>
    </div>
    <div class="card-body">
                ...
                <table class="table table-striped table-hover align-middle">
                    ...
                    <?php foreach ($users as $user): ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?= BASE_URL ?>/sa/user/edit/<?= $user->id ?>" class="btn btn-sm btn-warning">
                                    ✏️ <?= __('edit') ?>
                                </a>

                                <form action="<?= BASE_URL ?>/sa/user/delete/<?= $user->id ?>" method="post" class="d-inline"
