    ...
    <div class="row">
        ...
        <nav class="col-md-2 col-lg-2 d-md-block sidebar py-3">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/admin/bookings/settings"><?= __('booking_settings') ?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/admin/settings"><?= __('settings') ?></a></li>
                <li class="nav-item"><a class="nav-link" href="<?= BASE_URL ?>/admin/components"><?= __('component') ?></a></li>
