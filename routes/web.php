...
Route::middleware([InstanceMiddleware::class,AuthMiddleware::class, RoleMiddleware::class, CsrfMiddleware::class, /*RateLimiterMiddleware::class*/])->group(function () {
    ...
    Route::post('/admin/service/delete/{id}', [ServiceController::class, 'deleteService']);
    Route::post('/admin/services/delete', [ServiceController::class, 'deleteServices']);
...
Route::middleware([InstanceMiddleware::class,AuthMiddleware::class, RoleMiddleware::class])->group(function () {
    ...
    Route::get('/admin/services/delete', [ServiceController::class, 'deleteServices']);
    ...
    Route::get('/admin/bookings/get/employee/{dateId}/{timeId}', [AdminBookingController::class, 'getEmployeeByDateTime']);
    Route::get('/admin/bookings/get/time/{id}', [AdminBookingController::class, 'getServiceByTime']);
